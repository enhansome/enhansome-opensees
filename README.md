...
[![Analytics](https://ga-beacon.appspot.com/UA-112803115-1/github-repo-readme)](https://github.com/Hanlin-Dong/awesome-opensees) ⭐ 120 | 🐛 3 | 🌐 Tcl | 📅 2024-09-28
...
This awesome-list project is inspired by the project [awesome](https://github.com/sindresorhus/awesome) ⭐ 499,080 | 🐛 106 | 📅 2026-08-21. However, as OpenSees itself is rapidly growing, most of the related resources are not so mature. Therefore, the resources listed here may suffer from some limitations, or still under development but inspiring. The author doesn't take any responsibility for the accuracy of anything listed. You should judge whether to use them by yourself.
...
The official source code of OpenSees is available on Github! See [the repository](https://github.com/OpenSees/OpenSees) ⭐ 800 | 🐛 56 | 🌐 C++ | 📅 2026-08-14!
...
* [`sees` Python package](https://github.com/STAIRlab/sees) ⭐ 39 | 🐛 0 | 🌐 Python | 📅 2026-03-25 - A visualization framework for creating high quality and responsive renderings using glTF technology with support for both Python and Tcl. ![oss][oss] ![python][python] ![mac][mac] ![win][win]
* [OpenSees Model View](https://github.com/jamesmaguire/opensees-model-view) ⭐ 35 | 🐛 1 | 🌐 Python | 📅 2017-04-25 - A Python package that can be used to visualise your OpenSees model as the tcl file is written. ![oss][oss] ![python][python]
* [OpenSees 3D Visualisation](https://github.com/jamesmaguire/opensees-3d-visualisation) ⭐ 16 | 🐛 3 | 🌐 Tcl | 📅 2021-06-19 - A Python script that reads OpenSees simulation input and output files to create a 3D visualisation of your displaced model. ![oss][oss] ![python][python]
* [OpenSees Model Plotter Matlab](https://github.com/gerardjoreilly/OpenSees-Model-Plotter-Matlab) ⭐ 14 | 🐛 1 | 🌐 MATLAB | 📅 2019-11-19 - A Matlab-based plotter for models developed in OpenSees. ![oss][oss] ![matlab][matlab]
...
* [OpenSeesAPI](https://github.com/nassermarafi/OpenSeesAPI) ⭐ 46 | 🐛 0 | 🌐 Python | 📅 2020-11-26 - A Python package that is used to write OpenSees tcl scripts quickly. ![oss][oss] ![python][python]
* [OpenSeesAPI.m](https://github.com/andrewdsen/OpenSeesAPI.m) ⭐ 10 | 🐛 0 | 🌐 MATLAB | 📅 2020-05-11 - An OpenSees API for MATLAB. ![oss][oss] ![matlab][matlab]
* [Node-OpenSees](https://github.com/lge88/node-opensees) ⭐ 2 | 🐛 0 | 🌐 Tcl | 📅 2013-05-01 - A [Node.js](https://nodejs.org/) bind for OpenSees. (Not maintained, just for inspiration) ![oss][oss] ![skull][skull]
* [Script Generation via Templates](https://github.com/ucgmsim/OpenSees_script-generation) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2016-11-09 - An inspiring example of using Python template engine [Jinjia2](http://jinja.pocoo.org/) to generate massive tcl scripts. ![oss][oss]
...
* [Smart Analyze](https://github.com/Hanlin-Dong/SmartAnalyze) ⭐ 26 | 🐛 4 | 🌐 Python | 📅 2023-08-02 - A helper user procedure to improve convergence and speed up for both quasi-static and time-history analyses.
